 ...
 * @see com.curtisnewbie.service.auth.local.api.LocalOperateLogService#moveRecordsToHistory(MoveOperateLogToHistoryCmd)
 */
@Builder
public class MoveOperateLogToHistoryCmd {
